...
path_to_file = r"Works\Nietzsche\The_Dawn_of_Day.txt"                          #Define where to grab the text files
text = open(path_to_file, 'rb').read().decode('utf-8')      #Open the text files and read the contents
